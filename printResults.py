...
def printCrimeCount(result):
    # header
    print("-" * 144)
    print("{:12s}{:12s}{:12s}{:12s}{:12s}".format('County', 'Year', 'Violent', 'Property', 'Index'))
    print("{:12s}{:12s}{:12s}{:12s}{:12s}".format(''      , ''    , 'Crime'  , 'Crime'   , 'Crime'))
    print("{:12s}{:12s}{:12s}{:12s}{:12s}".format(''      , ''    , 'Count'  , 'Count'   , 'Count'))
    print("-" * 144)
    # content
    for entry in result:
        for item in entry:
